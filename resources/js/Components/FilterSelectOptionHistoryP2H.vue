<template>
    <div class="relative" ref="dropdown">
        ...
        <div
            v-show="showOptions"
            class="absolute z-10 w-full rs:w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg custom-scrollbar left-1/2 transform -translate-x-1/2 top-full"
        >
            <div class="py-1">
                <div
